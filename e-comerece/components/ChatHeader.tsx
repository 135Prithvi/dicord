...
export default function ChatHeader() {
  ...
  return (
    <>
      <div className="mt-[10px]  flex items-center  justify-between border-b-2 border-gray-700  px-2 text-white">
        <div className="flex">
          <Image
            alt=""
            src={at}
            width={24}
            height={24}
            className="mr-2.5 cursor-pointer text-white opacity-60 filter-none"
          />
          <h3 className="mx-2 ">{roomName}</h3>
        </div>
        {currentAccount ? (
          <div className="flex items-center">
            <button
              type="button"
              className="mr-2 mb-2 inline-flex  cursor-default items-center rounded-lg border   border-gray-800 bg-gray-900 px-2 py-1 text-center text-sm font-[550] text-white  hover:border-gray-700 hover:bg-gray-800"
            >
              <Image
                alt="eth"
                src={eth}
                width={18}
                height={18}
                className="cursor-pointer text-white opacity-60 filter-none"
              />
              <p className="ml-2.5">
          ...
          <div className="flex items-center">
            <button
              type="button"
              className="mr-2 mb-2 inline-flex items-center rounded-lg border border-gray-200 bg-white px-2 py-1 text-center text-sm font-medium text-gray-900 hover:bg-gray-100 focus:outline-none focus:ring-4 focus:ring-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:text-white dark:hover:bg-gray-700 dark:focus:ring-gray-600"
